...
public class FileStorageManager {
    ...
    private static String[] STANDARD_CONTRACTS = {CROWDSALE, HUMANSTANDARDTOKEN, ERC20TOKENSTANDART};
    private static String[] STANDARD_UUIDS = {CROWDSALEUUID, HUMANSTANDARDTOKENUUID, ERC20TOKENSTANDARTUUID};
