...
import com.eurekanetwork.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(com.eurekanetwork.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(com.eurekanetwork.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(com.eurekanetwork.wallet.R.id.checkbox)
