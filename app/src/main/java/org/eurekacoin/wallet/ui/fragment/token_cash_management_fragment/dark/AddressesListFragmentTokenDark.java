package com.eurekanetwork.wallet.ui.fragment.token_cash_management_fragment.dark;
...
import com.eurekanetwork.wallet.ui.fragment.token_cash_management_fragment.AddressesListFragmentToken;
import com.eurekanetwork.wallet.ui.fragment.token_cash_management_fragment.TokenAddressesAdapter;
...
public class AddressesListFragmentTokenDark extends AddressesListFragmentToken {
    ...
    protected int getLayout() {
        return com.eurekanetwork.wallet.R.layout.fragment_address_list;
    }

    @Override
    public void updateAddressList(List<AddressWithTokenBalance> deterministicKeyWithBalance, String currency) {
        if (mRecyclerView != null) {
            adapter = new TokenAddressesAdapter(deterministicKeyWithBalance, com.eurekanetwork.wallet.R.layout.item_address, this, currency, getPresenter().getDecimalUnits());
    ...
    protected void showTransferDialogFragment(final AddressWithTokenBalance keyWithBalanceTo, List<AddressWithTokenBalance> keyWithBalanceList, final int decimalUnits) {
        View view = LayoutInflater.from(getContext()).inflate(com.eurekanetwork.wallet.R.layout.dialog_transfer_balance_fragment, null);
        final TextInputEditText mEditTextAmount = (TextInputEditText) view.findViewById(com.eurekanetwork.wallet.R.id.et_amount);
        final Spinner spinner = (Spinner) view.findViewById(com.eurekanetwork.wallet.R.id.spinner_transfer);
        FontTextView mEditTextAddressTo = (FontTextView) view.findViewById(com.eurekanetwork.wallet.R.id.tv_address_to);
        ...
        view.findViewById(com.eurekanetwork.wallet.R.id.bt_back).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(com.eurekanetwork.wallet.R.id.bt_transfer).setOnClickListener(new View.OnClickListener() {
            @Override
