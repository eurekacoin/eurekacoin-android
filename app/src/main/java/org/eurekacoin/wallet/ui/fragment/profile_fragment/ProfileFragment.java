...
import com.eurekanetwork.wallet.ui.fragment.about_fragment.AboutFragment;
...
public abstract class ProfileFragment extends BaseNavFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(com.eurekanetwork.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            case com.eurekanetwork.wallet.R.string.language:
                fragment = LanguageFragment.newInstance(getContext());
                break;
            case com.eurekanetwork.wallet.R.string.change_pin:
                fragment = PinFragment.newInstance(CHANGING, getContext());
                break;
            case com.eurekanetwork.wallet.R.string.wallet_backup:
                fragment = PinFragment.newInstance(AUTHENTICATION_FOR_PASSPHRASE, getContext());
                break;
            case com.eurekanetwork.wallet.R.string.smart_contracts:
                fragment = SmartContractsFragment.newInstance(getContext());
                break;
            case com.eurekanetwork.wallet.R.string.subscribe_tokens:
                fragment = SubscribeTokensFragment.newInstance(getContext());
                break;
            case com.eurekanetwork.wallet.R.string.about:
                fragment = AboutFragment.newInstance(getContext());
                break;
            case com.eurekanetwork.wallet.R.string.log_out:
                ...
                break;
            case com.eurekanetwork.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case com.eurekanetwork.wallet.R.string.touch_id:
