...
import com.eurekanetwork.wallet.utils.SearchBar;
import com.eurekanetwork.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(com.eurekanetwork.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(com.eurekanetwork.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(com.eurekanetwork.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(com.eurekanetwork.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.eurekanetwork.wallet.R.id.tv_single_string)
        TextView mTextViewCurrency;
        @BindView(com.eurekanetwork.wallet.R.id.iv_check_indicator_blue)
        ImageView mImageViewCheckIndicator;
        @BindView(com.eurekanetwork.wallet.R.id.ll_single_item)
