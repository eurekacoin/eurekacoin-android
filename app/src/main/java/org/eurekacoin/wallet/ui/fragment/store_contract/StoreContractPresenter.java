...
import static com.eurekanetwork.wallet.datastorage.FileStorageManager.HUMANSTANDARDTOKENUUID;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_eurekacoin_address));
                    return;
                }
                //TODO STUB!
