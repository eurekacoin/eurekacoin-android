package com.eurekanetwork.wallet.ui.fragment.wallet_fragment.dark;
...
import com.eurekanetwork.wallet.utils.ResizeWidthAnimation;
...
public class WalletFragmentDark extends WalletFragment {
    ...
    public void updateBalance(String balance, String unconfirmedBalance) {
        try {
            balanceValue.setText(String.format("%s EUREKACOIN", balance));
            if (unconfirmedBalance != null) {
                ...
                uncomfirmedBalanceValue.setText(String.format("%s EUREKACOIN", unconfirmedBalance));
            } else {
                uncomfirmedBalanceValue.setVisibility(View.GONE);
                uncomfirmedBalanceTitle.setVisibility(View.GONE);
            }
