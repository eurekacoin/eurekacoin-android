...
public abstract class TouchIDPreferenceFragment extends BaseFragment implements TouchIDPreferenceView {
    ...
    @OnClick({com.eurekanetwork.wallet.R.id.bt_enable_touch_id, com.eurekanetwork.wallet.R.id.bt_not_now})
    public void onClick(View view) {
        switch (view.getId()) {
            case com.eurekanetwork.wallet.R.id.bt_enable_touch_id:
                getPresenter().onEnableTouchIdClick();
            case com.eurekanetwork.wallet.R.id.bt_not_now:
                if (!mIsImporting) {
