...
import com.eurekanetwork.wallet.ui.fragment.wallet_fragment.HistoryCountChangeListener;
...
import com.eurekanetwork.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
import com.eurekanetwork.wallet.utils.ClipboardUtils;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String eurekacoinAddressKey = "eurekacoinAddressKey";
    ...
    @Override
    public void setEurekacoinAddress(String address) {
        if (!TextUtils.isEmpty(address)) {
