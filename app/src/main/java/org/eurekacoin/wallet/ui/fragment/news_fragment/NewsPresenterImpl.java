...
public class NewsPresenterImpl extends BaseFragmentPresenterImpl implements NewsPresenter {
    ...
    public void onRefresh() {
        if (mNetworkConnectedFlag) {
            ...
            getView().setAlertDialog(com.eurekanetwork.wallet.R.string.no_internet_connection,
                    com.eurekanetwork.wallet.R.string.please_check_your_network_settings,
                    com.eurekanetwork.wallet.R.string.ok,
