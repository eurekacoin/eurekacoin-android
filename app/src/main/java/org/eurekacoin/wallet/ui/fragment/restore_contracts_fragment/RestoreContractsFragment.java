...
import com.eurekanetwork.wallet.utils.FileUtils;
import com.eurekanetwork.wallet.utils.FontCheckBox;
...
public abstract class RestoreContractsFragment extends BaseFragment implements RestoreContractsView {
    ...
    @BindView(com.eurekanetwork.wallet.R.id.rl_back_up_file)
    protected
    FrameLayout mFrameLayoutBackUpFile;
    @BindView(com.eurekanetwork.wallet.R.id.cb_restore_templates)
    FontCheckBox mCheckBoxRestoreTemplates;
    @BindView(com.eurekanetwork.wallet.R.id.cb_restore_contracts)
    FontCheckBox mCheckBoxRestoreContracts;
    @BindView(com.eurekanetwork.wallet.R.id.cb_restore_tokens)
    FontCheckBox mCheckBoxRestoreTokens;
    @BindView(com.eurekanetwork.wallet.R.id.cb_restore_all)
    FontCheckBox mCheckBoxRestoreAll;

    @BindView(com.eurekanetwork.wallet.R.id.tv_select_back_up)
    protected
    FontTextView mTextViewFileName;
    @BindView(com.eurekanetwork.wallet.R.id.tv_file_size)
    protected
    FontTextView mTextViewFileSize;
    @BindView(com.eurekanetwork.wallet.R.id.iv_restore_icon)
    protected
    ImageView mImageViewRestoreIcon;

    @OnClick({com.eurekanetwork.wallet.R.id.rl_back_up_file, com.eurekanetwork.wallet.R.id.cb_restore_templates, com.eurekanetwork.wallet.R.id.cb_restore_contracts, com.eurekanetwork.wallet.R.id.cb_restore_tokens, com.eurekanetwork.wallet.R.id.cb_restore_all, com.eurekanetwork.wallet.R.id.iv_restore_icon, com.eurekanetwork.wallet.R.id.ibt_back, com.eurekanetwork.wallet.R.id.bt_restore})
    public void onClick(View view) {
        switch (view.getId()) {
            case com.eurekanetwork.wallet.R.id.rl_back_up_file:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.iv_restore_icon:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.cb_restore_templates:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.cb_restore_contracts:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.cb_restore_tokens:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.cb_restore_all:
            ...
            case com.eurekanetwork.wallet.R.id.ibt_back:
                ...
                break;
            case com.eurekanetwork.wallet.R.id.bt_restore:
                if (mCheckBoxRestoreAll.isChecked()) {
