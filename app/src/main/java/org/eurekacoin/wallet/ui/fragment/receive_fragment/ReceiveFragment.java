...
import com.eurekanetwork.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "EUREKACOIN QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "Eurekacoin QR-Code"));
        }
    }
