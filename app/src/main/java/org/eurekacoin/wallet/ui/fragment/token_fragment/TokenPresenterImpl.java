...
import com.eurekanetwork.wallet.model.gson.history.HistoryPayType;
...
import com.eurekanetwork.wallet.ui.fragment.transaction_fragment.TransactionFragment;
...
public class TokenPresenterImpl extends BaseFragmentPresenterImpl implements TokenPresenter {
    ...
    private void setEurekacoinAddress() {
        getView().setEurekacoinAddress(getInteractor().getCurrentAddress());
    }
