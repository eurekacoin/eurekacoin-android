...
import com.eurekanetwork.wallet.ui.fragment.token_fragment.dark.TokenHistoryAdapterDark;
...
public class TokenFragmentLight extends TokenFragment {
    ...
    private final int LAYOUT = com.eurekanetwork.wallet.R.layout.lyt_token_fragment_light;

    @BindView(com.eurekanetwork.wallet.R.id.wave_view)
    WaveView waveView;
    private WaveHelper mWaveHelper;

    @BindView(com.eurekanetwork.wallet.R.id.bt_share)
    ImageButton mShareBtn;

    @BindView(com.eurekanetwork.wallet.R.id.iv_choose_address)
    ImageView mIvChooseAddress;

    @BindView(com.eurekanetwork.wallet.R.id.tv_token_name)
