...
public class EurekacoinService {

    private static EurekacoinService sEurekacoinService;
    private EurekacoinRestService mServiceApi;

    public static EurekacoinService newInstance() {
        if (sEurekacoinService == null) {
            sEurekacoinService = new EurekacoinService();
        }
        return sEurekacoinService;
    }

    private EurekacoinService() {
        try {
            ...
            mServiceApi = retrofit.create(EurekacoinRestService.class);
    ...
    public Observable<TokenHistoryResponse> getTokenHistoryList(String erc20ContractAddress, int limit, int offset, List<String> addresses){
        return mServiceApi.getTokenHistoryList(erc20ContractAddress, limit, offset, addresses);
    }
