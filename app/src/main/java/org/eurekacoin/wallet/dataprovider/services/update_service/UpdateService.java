package com.eurekanetwork.wallet.dataprovider.services.update_service;
...
import com.eurekanetwork.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import com.eurekanetwork.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import com.eurekanetwork.wallet.utils.BoughtContractBuilder;

import com.eurekanetwork.wallet.R;
import com.eurekanetwork.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import com.eurekanetwork.wallet.dataprovider.services.update_service.listeners.TokenListener;
import com.eurekanetwork.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import static com.eurekanetwork.wallet.WearListCallListenerService.ADDRESS;
import static com.eurekanetwork.wallet.WearListCallListenerService.BALANCE;
import static com.eurekanetwork.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static com.eurekanetwork.wallet.WearListCallListenerService.ITEMS;
import static com.eurekanetwork.wallet.WearListCallListenerService.UNC_BALANCE;
import static com.eurekanetwork.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final EurekacoinSharedPreference eurekacoinSharedPreference = EurekacoinSharedPreference.getInstance();

        String balanceString = eurekacoinSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = eurekacoinSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = eurekacoinSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        eurekacoinSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        eurekacoinSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        eurekacoinSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        EurekacoinService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
