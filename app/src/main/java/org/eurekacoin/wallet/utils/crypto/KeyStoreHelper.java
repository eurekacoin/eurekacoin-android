package com.eurekanetwork.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    public final static String EUREKACOIN_PIN_ALIAS = "eurekacoin_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = EurekacoinSharedPreference.getInstance().getSeed(context);
