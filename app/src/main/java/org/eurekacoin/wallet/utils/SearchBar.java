...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(com.eurekanetwork.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(com.eurekanetwork.wallet.R.id.text);
        input = (EditText) findViewById(com.eurekanetwork.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(com.eurekanetwork.wallet.R.id.placeholder);
        cancel = (Button) findViewById(com.eurekanetwork.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(com.eurekanetwork.wallet.R.id.bt_clear_search);
