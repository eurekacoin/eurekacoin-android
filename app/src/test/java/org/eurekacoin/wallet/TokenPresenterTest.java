...
import com.eurekanetwork.wallet.ui.fragment.token_fragment.TokenInteractor;
import com.eurekanetwork.wallet.ui.fragment.token_fragment.TokenPresenterImpl;
import com.eurekanetwork.wallet.ui.fragment.token_fragment.TokenView;
...
public class TokenPresenterTest {
    ...
    public void initialize_TokenWithDecimals() {
        ...
        verify(view, times(1)).setEurekacoinAddress(interactor.getCurrentAddress());
